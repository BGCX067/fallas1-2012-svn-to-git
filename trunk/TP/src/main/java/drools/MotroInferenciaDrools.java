...
public class MotroInferenciaDrools {
	...
	public String diagnosticar(int[] respuestas) {
		...
		try {
			...
			message.setMessage("No hay suficiente informaci&oacuten para realizar una evaluaci&oacuten. ");
	...
	public static class Message {
		...
		public void setRespuestas(int[] respuestas) {
			...
			this.resp17 = this.getRespuestaNumero(16);
		}

		public int getResp17() {
			return resp17;
		}

		public void setResp17(int resp17) {
			this.resp17 = resp17;
		}
